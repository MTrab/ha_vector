    ...
    def _done_callback(self, completed_future):
        ...
        if exc:
            ...
            if isinstance(exc, TypeError) and "positional arguments but" in str(exc):
                self.logger.error(
                    "The subscribed function may be missing parameters in its definition. Make sure it has robot, event_type and event positional parameters. (%s)",
                    exc,
                )
